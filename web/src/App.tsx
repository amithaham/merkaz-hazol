...
export default function App() {
  ...
  const localBusinessData = {
    ...
    description:
      "מרכז הזול סוקולוב 55 רמת השרון. החנות המובילה לחומרי ניקוי, חיטוי, בישום, תכשירי שיער, קוסמטיקה, כלים חד״פ, היגיינה, גרביים, נעלי בית ועוד.",
  ...
  return (
    <main id="top" dir="rtl">
      ...
      <div className="announcement-bar">
        ...
        <a href={phoneHref}>
          <span>להזמנות:</span>
          <bdi className="announcement-phone" dir="ltr">
            {phoneDisplay}
          </bdi>
        </a>
      </div>
      ...
      <header className="site-header">
        <div className="nav-shell">
          ...
          <a className="header-action contact-desktop" href="#visit">
            צור קשר
          </a>

          <a className="header-action contact-mobile" href={phoneHref}>
            צור קשר
          </a>
        </div>
      </header>
      ...
      >
        <div className="hero-content">
          ...
          <div className="hero-actions">
            ...
            <a
              className="quiet-link contact-desktop"
              href="#visit"
            >
              צור קשר
            </a>
            ...
            <a
              className="quiet-link contact-mobile"
              href={phoneHref}
            >
              צור קשר
            </a>
      ...
      <section
        ...
        aria-label="האחים ממשפחת חכם בכניסה לחנות מרכז הזול"
        data-reveal
      >
        <img
      ...
      >
        ...
        <div className="story-panel" data-reveal>
          <blockquote>
            העסק הוקם בשנת 1973 על ידי אבינו, מאיר חכם ז״ל. כיום אנחנו
            גאים להמשיך את דרכו ולשמור על הערכים שליוו את החנות לאורך
            השנים - אדיבות, מקצועיות, יחס אישי ומחירים מצוינים.
          </blockquote>
        </div>
      </section>
      ...
      >
        ...
        <div className="service-strip">
          <div data-reveal>
            ...
            <p>
              שירות אדיב ומקצועי, עם נכונות לעזור בכל שאלה
            </p>
          </div>

          <div data-reveal>
            <strong>
              מבחר רחב במחירים מצוינים
            </strong>
            <p>
              כל המוצרים שאתם צריכים, במקום אחד ובמחירים משתלמים
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="section-heading" data-reveal>
          ...
          <p className="section-description">
            אצלנו תמצאו מגוון רחב של מוצרי ניקיון, קוסמטיקה, בישום,
            שיער והיגיינה, ממותגים מוכרים ואהובים.
          </p>
        </div>
      ...
      >
        <div className="collection-heading" data-reveal>
          ...
          <div className="collection-guide">
            <p>
              החליקו שמאלה וימינה כדי לצפות בכל המוצרים
            </p>

            <div
              className="collection-controls"
              aria-label="גלילה בין המוצרים"
            >
              <button
                type="button"
                data-collection-direction="right"
              ...
              <button
                type="button"
                data-collection-direction="left"
      ...
      >
        <div className="visit-copy" data-reveal>
          ...
          <p>
            משלוחים חינם לרמת השרון ולהרצליה
          </p>
          ...
          <div className="visit-image">
            <img
              src="/store/cleaning-display.jpg"
              alt="מדפי חומרי הניקוי במרכז הזול"
              loading="lazy"
            />
          </div>
        </div>
...
function InteractiveEffects() {
  useEffect(() => {
    ...
    const scrollCollection = (event: Event) => {
      ...
      const direction =
        button.dataset.collectionDirection === "left"
          ? -1
          : 1;
